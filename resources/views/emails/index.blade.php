                ...
                <tr style="border-collapse:collapse">
                    ...
                    <tr style="border-collapse:collapse">
                        ...
                        @if(isset($mailData['firstname']))
                            Message de : {{ $mailData['firstname'] }} {{ $mailData['lastname'] }} </h6></td>
                        @endif
                        </tr>
                    </table></td>
                </tr>
                ...
                <td align="left" style="Margin:0;padding-right:20px;padding-left:20px;padding-top:10px;padding-bottom:10px">
                    <table width="100%" cellspacing="0" cellpadding="0" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                        ...
                        <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;border-radius:0px" width="100%" cellspacing="0" cellpadding="0" role="presentation">
                            <tr style="border-collapse:collapse">
                            <td class="es-text-4350" style="Margin:0;padding-top:5px;padding-bottom:5px;padding-right:40px;padding-left:40px"><h6 style="Margin:0;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:16px;font-style:normal;font-weight:normal;line-height:19px;color:#333333" class="es-m-txt-c">
                            Sujet du message : {{ $mailData['subject'] }}</h6></td>
                        </tr>
                        </table></td>
                        </tr>
                    </table>
            ...
            <table class="es-content-body" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:600px">
                ...
                <table width="100%" cellspacing="0" cellpadding="0" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                    ...
                    <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;border-radius:0px" width="100%" cellspacing="0" cellpadding="0" role="presentation">
                        <tr style="border-collapse:collapse">
                        <td class="es-text-4350" style="Margin:0;padding-top:5px;padding-bottom:5px;padding-right:40px;padding-left:40px"><h6 style="Margin:0;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:16px;font-style:normal;font-weight:normal;line-height:19px;color:#333333" class="es-m-txt-c">
                        Message : {{ $mailData['message'] }}</h6></td>
                    </tr>
                    </table></td>
                    </tr>
                </table></td>
